...
Pacf(d.res, main = "Pacf residuals") #AR(3) # zdej spet pride 10??
...
Acf(d.res, main = "Acf residuals") #MA(5) ali MA(7), to se mi zdi čudno: ne nič od tega
