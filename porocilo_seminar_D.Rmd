...
komentar <- paste('Augmented Dickey-Fuller Test ne zavrne hipoteze o nestacionarnosti.')
print(komentar)
```
...
komentar <- paste('Shapirov test zavrne hipotezo in s tem sprejme normalno porazdelitev.')
print(komentar)
...
komentar <- paste('Tudi iz grafa je očitno, da gre za normalno porazdelitev.')
print(komentar)
```
...
komentar <- paste('Box-Pierceov test zavrne hipotezo in sprejme alternativo o belem šumu.')
print(komentar)

# Ljung-Box test
Box.test(x.res, lag = 1, type="Ljung-Box") #p-value = 0.7498

komentar <- paste('Ljung-Boxov test zavrne hipotezo in prav tako sprejme alternativo o belem šumu.')
print(komentar)
...
komentar <- paste('Augmented Dickey-Fuller Test ne zavrne hipoteze, torej nimamo stacionarnosti.')
print(komentar)
...
komentar <- paste('Shapirov test ne zavrne hipoteze, torej ne moremo sklepati o normalni porazdelitvi.') # to je malo sus
print(komentar)
...
komentar <- paste('Shapirov test ne zavrne hipoteze, kljub temu, da je iz grafa razvidno drugače.')
print(komentar)
```
...
komentar <- paste('Box-Pierceov test ne zavrne hipoteze, torej ne gre za beli šum.')
print(komentar)


Box.test(d.res, lag = 1, type="Ljung-Box") #p-value = 2.22e-16

komentar <- paste('Ljung-Boxov test ne zavrne hipoteze, torej ne gre za beli šum.')
print(komentar)
